...
```shell
sudo docker pull elasticsearch:7.6.2 // 存储和检索数据
sudo docker pull kibana:7.6.2 // 可视化检索数据
```
...
// 用户权限问题，elasticsearch启动报错，分配映射文件读写权限
...
![image-20200501192629304](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAxMTkyNjI5MzA0LnBuZw?x-oss-process=image/format,png)
...
下面是在postman中的测试数据：
![image-20200501194449944](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAxMTk0NDQ5OTQ0LnBuZw?x-oss-process=image/format,png)
...
![image-20200501195619925](https://fermhan.oss-cn-qingdao.aliyuncs.com/guli/image-20200501195619925.png)

再次使用POST插入数据，仍然是新增的：

![image-20200501195732492](https://fermhan.oss-cn-qingdao.aliyuncs.com/guli/image-20200501195732492.png)

添加数据的时候，指定ID，会使用该id，并且类型是新增：

![image-20200501200048361](https://fermhan.oss-cn-qingdao.aliyuncs.com/guli/image-20200501200048361.png)

再次使用POST插入数据，类型为updated

![image-20200501200132199](https://fermhan.oss-cn-qingdao.aliyuncs.com/guli/image-20200501200132199.png)
...
![image-20200501212224983](https://fermhan.oss-cn-qingdao.aliyuncs.com/guli/image-20200501212224983.png)

（2）将name更新为2，更新过程中使用seq_no=6

http://192.168.137.14:9200/customer/external/1?if_seq_no=6&if_primary_term=1

![image-20200501213047499](https://fermhan.oss-cn-qingdao.aliyuncs.com/guli/image-20200501213047499.png)
...
![image-20200501212924094](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAxMjEyOTI0MDk0LnBuZw?x-oss-process=image/format,png)
...
![image-20200501213130001](https://fermhan.oss-cn-qingdao.aliyuncs.com/guli/image-20200501213130001.png)

#### 2.4 更新文档

![image-20200501214522818](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAxMjE0NTIyODE4LnBuZw?x-oss-process=image/format,png)

![image-20200501215746139](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAxMjE1NzQ2MTM5LnBuZw?x-oss-process=image/format,png)

（1）POST更新文档，带有_update

http://192.168.137.14:9200/customer/external/1/_update

![image-20200501214810741](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAxMjE0ODEwNzQxLnBuZw?x-oss-process=image/format,png)

如果再次执行更新，则不执行任何操作，序列号也不发生变化

![image-20200501214912607](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAxMjE0OTEyNjA3LnBuZw?x-oss-process=image/format,png)

POST更新方式，会对比原来的数据，和原来的相同，则不执行任何操作（version和_seq_no）都不变。

（2）POST更新文档，不带_update

![image-20200501215358666](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAxMjE1MzU4NjY2LnBuZw?x-oss-process=image/format,png)
...
![image-20200501220559094](https://fermhan.oss-cn-qingdao.aliyuncs.com/guli/image-20200501220559094.png)
...
![image-20200501221105476](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAxMjIxMTA1NDc2LnBuZw?x-oss-process=image/format,png)
...
![image-20200501233938697](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAxMjMzOTM4Njk3LnBuZw?x-oss-process=image/format,png)

![image-20200502000221422](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAyMDAwMjIxNDIyLnBuZw?x-oss-process=image/format,png)

![image-20200502000733594](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAyMDAwNzMzNTk0LnBuZw?x-oss-process=image/format,png)
...
> 避免对文本字段使用“term”查询
>
> By default, Elasticsearch changes the values of `text` fields as part of [analysis](https://blog.csdn.net/hancoder/article/details/107612746). This can make finding exact matches for `text` field values difficult.
>
> 默认情况下，Elasticsearch作为[analysis](https://blog.csdn.net/hancoder/article/details/107612746)的一部分更改’ text '字段的值。这使得为“text”字段值寻找精确匹配变得困难。
>
...
![image-20200502120921830](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAyMTIwOTIxODMwLnBuZw?x-oss-process=image/format,png)
...
![image-20200502161339291](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAyMTYxMzM5MjkxLnBuZw?x-oss-process=image/format,png)
...
![image-20200502170924399](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAyMTcwOTI0Mzk5LnBuZw?x-oss-process=image/format,png)
...
![image-20200502174825233](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAyMTc0ODI1MjMzLnBuZw?x-oss-process=image/format,png)
...
![image-20200502175901959](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAyMTc1OTAxOTU5LnBuZw?x-oss-process=image/format,png)
...
![image-20200502181432745](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAyMTgxNDMyNzQ1LnBuZw?x-oss-process=image/format,png)
...
![image-20200502182929583](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTAyMTgyOTI5NTgzLnBuZw?x-oss-process=image/format,png)
...
![image-20200511074437763](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTExMDc0NDM3NzYzLnBuZw?x-oss-process=image/format,png)
...
![image-20200511111618183](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9mZXJtaGFuLm9zcy1jbi1xaW5nZGFvLmFsaXl1bmNzLmNvbS9ndWxpL2ltYWdlLTIwMjAwNTExMTExNjE4MTgzLnBuZw?x-oss-process=image/format,png)
...
```shell
[root@leelasticsearch]# pingbaidu.com  // 检查是否能ping通外网
ping: baidu. com: Name or service not known

[root@10 elasticsearch ]# cd /etc/sysconfig/network-scripts/

vi ifconfig-eth1  // 编辑网卡信息（找到当前网络ip所在的网卡 ip addr）
